...
load_driven_terrain_item_filler::load_driven_terrain_item_filler(
    std::unique_ptr<item_spawner>&& spawner)
    : terrain_item_filler{*spawner}
    , owned_spawner{std::move(spawner)}
...
void load_driven_terrain_item_filler::fill_terrain()
{
...
double load_driven_terrain_item_filler::get_minimum_load_factor() const
{
    return this->minimum_load_factor;
}

double load_driven_terrain_item_filler::get_maximum_load_factor() const
{
    return this->maximum_load_factor;
}

void load_driven_terrain_item_filler::set_minimum_load_factor(
    double const factor)
{
...
void load_driven_terrain_item_filler::set_maximum_load_factor(
    double const factor)
{
...
double load_driven_terrain_item_filler::
    get_maximum_load_factor_upper_limit() const
{
    return 0.50;
}

terrain& load_driven_terrain_item_filler::get_terrain() const
{
    return this->spawner.ground;
}

int load_driven_terrain_item_filler::
    get_num_of_items_currently_on_terrain() const
{
    auto& t = get_terrain();
...
int load_driven_terrain_item_filler::
    get_total_num_of_item_positions_on_terrain() const
{
    auto& t = get_terrain();
...
void load_driven_terrain_item_filler::recompute_range_of_allowed_num_of_items()
{
